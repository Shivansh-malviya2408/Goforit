...
//       roomNumber: '308',
//       checkIn: 'Mar 5, 4:00 PM',
//       checkOut: 'Mar 12, 10:00 AM',
//       status: 'expired',
//       location: 'Swiss Alps',
//       keyCode: 'AR-308-E2D1',
//       batteryLevel: 0,
...
//   // 3. Removed: type annotation (status: string)
...
//   // 4. Removed: type annotation (status: string)
...
//         <div>
//           <h1 className="text-3xl font-bold text-gray-900">Digital Hotel Keys</h1>
//           <p className="text-gray-600 mt-1">Secure, contactless hotel access</p>
//         </div>
...
//                     </div>
//                     <div>
//                       <h3 className="font-semibold text-gray-900">{key.hotelName}</h3>
//                       <p className="text-sm text-gray-600">Room {key.roomNumber}</p>
//                     </div>
//                   </div>
...
//                       key.batteryLevel > 50 ? 'text-green-600' :
//                       key.batteryLevel > 20 ? 'text-yellow-600' : 'text-red-600'
//                     }`} />
//                     <span className="text-sm text-gray-600">Battery: {key.batteryLevel}%</span>
//                   </div>
//                   <span className="text-sm text-gray-600">Last used: {key.lastUsed}</span>
//                 </div>
...
//                   <div className="flex items-center justify-between">
//                     <div>
//                       <p className="text-xs text-gray-600 mb-1">Digital Key Code</p>
//                       <p className="font-mono text-sm font-medium text-gray-900">{key.keyCode}</p>
//                     </div>
...
//                   <p className="text-sm font-medium text-gray-700">Access Features:</p>
...
//                     </button>
//                   ) : (
//                     <button className="w-full bg-gray-300 text-gray-500 py-2 px-4 rounded-lg text-sm font-medium cursor-not-allowed">
//                       Key Expired
//                     </button>
//                   )}
//                 </div>
...
//             <p className="text-sm text-gray-600">All digital keys use AES-256 encryption for maximum security</p>
//           </div>
//           <div>
//             <h3 className="font-medium text-gray-900 mb-2">Time-Limited Access</h3>
//             <p className="text-sm text-gray-600">Keys automatically expire after checkout for enhanced security</p>
//           </div>
//           <div>
//             <h3 className="font-medium text-gray-900 mb-2">Offline Capable</h3>
//             <p className="text-sm text-gray-600">Keys work without internet connection for reliable access</p>
//           </div>
//         </div>
//       </div>
//     </div>
